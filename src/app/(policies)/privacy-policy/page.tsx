  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-white">
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">Interpretation and Definitions</h2>
          <div className="pl-4 border-l-4 border-gray-200 space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Abacus, accessible from{" "}
                    <a
                      href="https://abacuss.online"
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">Collecting and Using Your Personal Data</h2>
          <div className="pl-4 border-l-4 border-gray-200 space-y-4">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 mb-2">Usage Data is collected automatically when using the Service.</p>
              <p className="text-gray-600 mb-2">
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium text-gray-700 mb-2">Tracking Technologies and Cookies</h4>
              <p className="text-gray-600 mb-2">
          ...
          <div className="mt-6 pl-4 border-l-4 border-gray-200">
            <h3 className="text-xl font-medium text-gray-700 mb-2">Use of Your Personal Data</h3>
            ...
            <p className="text-gray-600 mt-4 mb-2">We may share Your personal information in the following situations:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li>
          ...
          <div className="mt-6 pl-4 border-l-4 border-gray-200">
            <h3 className="text-xl font-medium text-gray-700 mb-2">Retention of Your Personal Data</h3>
            <p className="text-gray-600 mb-2">
          ...
          <div className="mt-6 pl-4 border-l-4 border-gray-200">
            <h3 className="text-xl font-medium text-gray-700 mb-2">Transfer of Your Personal Data</h3>
            <p className="text-gray-600 mb-2">
          ...
          <div className="mt-6 pl-4 border-l-4 border-gray-200">
            <h3 className="text-xl font-medium text-gray-700 mb-2">Delete Your Personal Data</h3>
            <p className="text-gray-600 mb-2">
          ...
          <div className="mt-6 pl-4 border-l-4 border-gray-200">
            <h3 className="text-xl font-medium text-gray-700 mb-2">Disclosure of Your Personal Data</h3>
            <div className="ml-4">
              <h4 className="text-lg font-medium text-gray-700 mb-2">Business Transactions</h4>
              <p className="text-gray-600">
            ...
            <div className="ml-4 mt-4">
              <h4 className="text-lg font-medium text-gray-700 mb-2">Law enforcement</h4>
              <p className="text-gray-600">
            ...
            <div className="ml-4 mt-4">
              <h4 className="text-lg font-medium text-gray-700 mb-2">Other legal requirements</h4>
              <p className="text-gray-600 mb-2">
          ...
          <div className="mt-6 pl-4 border-l-4 border-gray-200">
            <h3 className="text-xl font-medium text-gray-700 mb-2">Security of Your Personal Data</h3>
            <p className="text-gray-600">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">Links to Other Websites</h2>
          <div className="pl-4 border-l-4 border-gray-200">
            <p className="text-gray-600 mb-2">
        ...
        <section>
          ...
          <div className="pl-4 border-l-4 border-gray-200">
            ...
            <ul className="list-disc pl-6 text-gray-600">
              <li>By email: <a href="mailto:abacusinsights001@gmail.com" className="text-blue-600 hover:underline">abacusinsights001@gmail.com</a></li>
            </ul>
          </div>
        </section>
      </div>
